...
struct BreathingStarField: View {
    ...
    private let specs: [StarSpec] = [
        ...
        StarSpec(x: 0.88, y: 0.04, size: 2.8, baseOpacity: 0.80, twinkleSpeed: 3.2, color: Color(hex: "F0C060")),
        StarSpec(x: 0.42, y: 0.09, size: 1.6, baseOpacity: 0.50, twinkleSpeed: 2.1, color: .white),
        StarSpec(x: 0.73, y: 0.15, size: 2.4, baseOpacity: 0.70, twinkleSpeed: 3.6, color: Color(hex: "CC88FF")),
        ...
        StarSpec(x: 0.06, y: 0.32, size: 1.4, baseOpacity: 0.45, twinkleSpeed: 3.1, color: Color(hex: "B8A8D0")),
        StarSpec(x: 0.58, y: 0.29, size: 2.0, baseOpacity: 0.35, twinkleSpeed: 2.7, color: .white),
        StarSpec(x: 0.80, y: 0.38, size: 2.6, baseOpacity: 0.72, twinkleSpeed: 3.8, color: Color(hex: "F0C060")),
        StarSpec(x: 0.16, y: 0.45, size: 1.0, baseOpacity: 0.38, twinkleSpeed: 2.3, color: .white),
        StarSpec(x: 0.67, y: 0.50, size: 1.8, baseOpacity: 0.52, twinkleSpeed: 3.4, color: Color(hex: "CC88FF")),
        StarSpec(x: 0.33, y: 0.58, size: 1.4, baseOpacity: 0.60, twinkleSpeed: 2.9, color: .white),
        StarSpec(x: 0.90, y: 0.60, size: 2.2, baseOpacity: 0.42, twinkleSpeed: 4.2, color: Color(hex: "B8A8D0")),
        ...
        StarSpec(x: 0.77, y: 0.78, size: 2.8, baseOpacity: 0.62, twinkleSpeed: 3.5, color: Color(hex: "F0C060")),
        StarSpec(x: 0.20, y: 0.84, size: 1.6, baseOpacity: 0.44, twinkleSpeed: 2.2, color: .white),
        StarSpec(x: 0.60, y: 0.89, size: 1.4, baseOpacity: 0.50, twinkleSpeed: 3.7, color: Color(hex: "CC88FF")),
        ...
        StarSpec(x: 0.12, y: 0.56, size: 2.0, baseOpacity: 0.42, twinkleSpeed: 2.8, color: Color(hex: "B8A8D0")),
        ...
        StarSpec(x: 0.63, y: 0.66, size: 2.4, baseOpacity: 0.58, twinkleSpeed: 2.6, color: Color(hex: "F0C060")),
        StarSpec(x: 0.29, y: 0.76, size: 1.0, baseOpacity: 0.33, twinkleSpeed: 3.2, color: .white),
        StarSpec(x: 0.71, y: 0.33, size: 1.8, baseOpacity: 0.48, twinkleSpeed: 2.9, color: Color(hex: "CC88FF")),
        StarSpec(x: 0.52, y: 0.95, size: 1.4, baseOpacity: 0.40, twinkleSpeed: 3.6, color: .white),
        StarSpec(x: 0.18, y: 0.02, size: 3.0, baseOpacity: 0.85, twinkleSpeed: 4.1, color: Color(hex: "F0C060")),
    ]
