...
private let oracleDeck: [OracleCard] = [
    ...
    .init(id: 5, name: "Sacred Union", symbol: "infinity", theme: "Union",
          ...
          affirmation: "I am ready. The Most High has ordained this union.", color: Color(hex: "CC88FF")),
    .init(id: 6, name: "Separation & Growth", symbol: "arrow.left.and.right", theme: "Distance",
          ...
          affirmation: "I grow stronger in this sacred space.", color: Color(hex: "7EC8A0")),
    ...
    .init(id: 16, name: "Sacred Contracts", symbol: "doc.fill", theme: "Destiny",
          ...
          affirmation: "I honor the sacred contract between our souls.", color: Color(hex: "CC88FF")),
    ...
    .init(id: 23, name: "The Veil Thins", symbol: "wind", theme: "Mysticism",
          ...
          affirmation: "I am open to receive messages from the divine.", color: Color(hex: "CC88FF")),
    ...
    .init(id: 25, name: "Karmic Release", symbol: "xmark.circle.fill", theme: "Release",
          ...
          affirmation: "I release all karmic debt with love and gratitude.", color: Color(hex: "7EC8A0")),
    ...
    .init(id: 29, name: "The Healing Journey", symbol: "cross.case.fill", theme: "Healing",
          ...
          affirmation: "My healing is the path to my union.", color: Color(hex: "7EC8A0")),
    ...
    .init(id: 33, name: "Twin Flame Frequency", symbol: "waveform", theme: "Vibration",
          ...
          affirmation: "I vibrate at the frequency the Most High designed for my union.", color: Color(hex: "CC88FF")),
    ...
    .init(id: 37, name: "The Homecoming", symbol: "house.heart.fill", theme: "Return",
          ...
          affirmation: "I am home in my own soul. My twin is coming home.", color: Color(hex: "7EC8A0")),
    ...
    .init(id: 41, name: "The Sacred Marriage", symbol: "rings.wedding", theme: "Union",
          ...
          affirmation: "I am whole, complete, and lovingly committed to myself.", color: Color(hex: "CC88FF")),
