...
private let allAffirmations: [ShareAffirmation] = [
    ...
    .init(text: "My crown is activated. I receive divine truth clearly.", category: "Spiritual", color: AppColors.coral),
    ...
    .init(text: "Every trigger is a teacher. I welcome the growth this love brings.", category: "Healing", color: AppColors.sage),
    .init(text: "My healing is my reunion. As I become whole, love returns.", category: "Healing", color: Color(hex: "43A047")),
    .init(text: "I vibrate at the frequency of unconditional love.", category: "Frequency", color: AppColors.coral),
    ...
    .init(text: "I am the divine feminine/masculine in full bloom.", category: "Spiritual", color: AppColors.coral),
